function Model = load_dyamond_um5ktest(ObsGrid)

% % ObsGrid = load('C:\Data\corwin\sampling_project\tracks\AIRS_3D\track_airs3d_734419_g195.mat');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%load UM 5km run data from DYAMOND-WINTER, using CDO to trim the data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%paths
ModelPath = '/work/ka1081/DYAMOND_WINTER/MetOffice/UM-5km/DW-ATM/atmos/3hr/ta/r1i1p1f1/ml/gn/';
...
for iFile=1:1:numel(Files)
  ...
  for iSource=1:2
    ...
    switch iSource
      case 1; Source = 'pfull';  %this is pressure at RHO levels, phalf for rpessure at THETA levels
      case 2; Source = 'ta';
    end
