function Model = load_era5_scatteredtest(DayNumber,MaxPrs,MinPrs)

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%load ERA5 data for a particular day, and put into common analysis format
%
%modified to return 1D arrays in order to test scattered interpolation
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[Model.Lon,Model.Lat,Model.Prs] = ndgrid(Model.Lon,Model.Lat,Model.Prs);
Model.Lon = Model.Lon(:);
Model.Lat = Model.Lat(:);
Model.Prs = Model.Prs(:);
Model.T   = reshape(Model.T,[numel(Model.Time),numel(Model.Prs)]);
